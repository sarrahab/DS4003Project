    ...
    html.Div([
        ...
        html.Div([
            dcc.Dropdown(
                ...
                value=[df['country'].tolist()[0]],  # default value as first country!
        ...
        html.Div([
            dcc.RangeSlider(
                ...
                marks= {year: str(year) if year % 100 == 0 else '' for year in range(min_yr, max_yr+1, 50)},  # for user friendliness, tick marks every 50 years and a year text label every 100 years
